...
namespace Inversus
    {
        ...
        public void checkSquare(laser laserpewpew)
        {
            ...
            //if the square isnt moveable for the current player then change to moveable state
        ...
        public void resetGrid()
        {
            for(int i =0; i < maxX; i++)
            {
                ...
                {
                    grid[i, counter] = 0;
                    visualGrid[i, counter].BackColor = System.Drawing.Color.Transparent;
                }
            }
        }
            ...
            public Inversus()
        {
            ...
            for(int i =0; i<maxX; i++)
            {
                for(int counter = 0; counter<maxY; counter++)
                {
                    ...
                    visualGrid[i,counter].SetBounds((i) * (sizeOfSquare + 1), (counter) * (sizeOfSquare + 1), sizeOfSquare, sizeOfSquare);
                    Controls.Add(visualGrid[i,counter]);
                }
            }
            this.Size = new System.Drawing.Size((maxX + 1) * (sizeOfSquare + 1), (1 + maxY) * (sizeOfSquare + 1));
